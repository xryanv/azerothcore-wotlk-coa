...
int main()
{
    ...
    for (Fields const& fields : {
        ...
        if (ClassifyRequest(fields) != RequestClass::Invalid)
            return 2;
    ...
    for (Fields const& fields : {
        ...
        Fields{"1", "r", "ADMIN", "TIER", "1", "2", "1", "100"},
        Fields{"1", "r", "ADMIN", "ASSIGN", "1", "2", "1", "appearance", "100", "100", "1", "Hat"},
    ...
    if (ClassifyRequest(Fields{"1", "r", "ADMIN", "SETTING", "1", "2", "quest"}) != RequestClass::Invalid)
        return 5;
    if (ClassifyRequest(Fields{"1", "r", "ADMIN", "TIER", "1", "2", "1", "100", "25"}) != RequestClass::Invalid)
        return 6;
    if (ClassifyRequest(Fields{"1", "r", "ADMIN", "ASSIGN", "1", "2", "1", "appearance", "100", "100", "1"}) != RequestClass::Invalid)
        return 7;
