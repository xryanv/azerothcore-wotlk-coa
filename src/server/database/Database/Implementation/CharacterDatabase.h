...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    // CoA account-wide seasonal progression.
    CHAR_SEL_COA_SCHEMA,
    CHAR_SEL_COA_SEASONS,
    CHAR_SEL_COA_SETTINGS,
    CHAR_SEL_COA_TIERS,
    CHAR_SEL_COA_TIER_REWARDS,
    CHAR_SEL_COA_ACCOUNTS,
    CHAR_SEL_COA_TIER_GRANT,
    CHAR_SEL_COA_ACCOUNT_CHARACTER,
    CHAR_SEL_COA_LOCKOUTS,
    CHAR_SEL_COA_LEVELS,
    CHAR_SEL_COA_REQUEST,
    CHAR_REP_COA_SEASON,
    CHAR_REP_COA_SETTING,
    CHAR_REP_COA_TIER,
    CHAR_REP_COA_TIER_REWARD,
    CHAR_REP_COA_ACCOUNT,
    CHAR_REP_COA_LOCKOUT,
    CHAR_REP_COA_LEVEL,
    CHAR_DEL_COA_ACCOUNTS,
    CHAR_DEL_COA_LOCKOUTS,
    CHAR_DEL_COA_TIER_GRANTS,
    CHAR_INS_COA_REQUEST,
    CHAR_INS_COA_TIER_GRANT,
    CHAR_INS_COA_AUDIT,
    CHAR_SEL_COA_HISTORY,
    CHAR_SEL_COA_APPEARANCE,
    CHAR_SEL_COA_APPEARANCES,
    CHAR_INS_COA_APPEARANCE,
    CHAR_SEL_COA_VANITY,
    CHAR_SEL_COA_VANITIES,
    CHAR_INS_COA_VANITY,
